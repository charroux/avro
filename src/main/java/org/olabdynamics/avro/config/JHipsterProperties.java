...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avroDataFormat@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avroDataFormat API";

        private String description = "avroDataFormat API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avroDataFormat";
